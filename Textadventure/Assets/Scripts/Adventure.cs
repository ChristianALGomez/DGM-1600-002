...
public class Adventure : MonoBehaviour {
    ...
    public enum States { Barrocks, Celler, Armory, CourtYard, Tower, Gate, Crack, Cave, RT, MT, LT, Hole,
        StoneStairsDown, OldRuins, EvilCult, MainSt, SkyLight, Freedom, TowerWall};
    ...
    private void Cave()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha3)) { currentState = States.MT; }
        if (Input.GetKeyDown(KeyCode.Alpha4)) { currentState = States.LT; }
    }
